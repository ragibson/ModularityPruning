...
from utilities import domains_to_gamma_omega_estimates, \
    gamma_omega_estimates_to_stable_partitions, iterative_multilayer_resolution_parameter_estimation, \
    repeated_parallel_louvain_from_gammas_omegas, Progress, CHAMP_3D, num_communities
...
def plot_2d_domains_with_num_communities(domains_with_estimates, xlim, ylim, flip_axes=False):
    # TODO: should this be moved to plotting?
