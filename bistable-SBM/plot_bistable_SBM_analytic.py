...
plt.axvline(cross1, color='red', linestyle='dashed', label="$\delta=0.02251$")
plt.axvline(cross2, color='purple', linestyle='dashed', label="$\delta=0.04966$")
...
plt.plot(deltas, [gamma_cross_limit(d) for d in deltas], label="Optimality switch from $K=2$ to $K=3$")
